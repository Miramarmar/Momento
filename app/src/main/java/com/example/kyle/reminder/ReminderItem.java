...
public class ReminderItem implements Parcelable {
  ...
  public ReminderItem(Cursor cursor) {
    ...
    mCateg = cursor.getString(cursor.getColumnIndex(ReminderParams.CATEG));
  ...
  public void setCateg(String mCateg) {
    this.mCateg = mCateg;
  }
